 ...
 */
class MiddlemanServiceTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        $this->buttonFactoryMock = $this->getMockBuilder(ButtonFactory::class)
            ...
            ->setMethods(['create'])
            ->getMock();
        $this->requestButtonBuilderMock = $this->getMockBuilder(RequestBuilder::class)
            ->disableOriginalConstructor()
            ->getMock();
        $this->requestButtonCommandMock = $this->getMockBuilder(RequestCommand::class)
            ->disableOriginalConstructor()
            ->getMock();
